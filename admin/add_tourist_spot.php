...
VALUES ('$tour_name','$admin', '$tour_des','$divi_id','$dist_id','$images','$status')";
      ...
      <div class="container-fluid px-4">
        <div class="card shadow-lg border-0 rounded-lg">
          <div class="card-header">
            <h4 class="text-center my-4">Add Tourist Spot</h4>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-floating mb-3 mb-md-0">
                    ...
                    <label for="inputFirstName">Tourist Spot Name</label>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-floating mb-3 mb-md-0">
                    ...
                    <label style="margin-top: -38px;" for="inputPassword">Give a short description of the tourist spot</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating mb-3 mb-md-0">
